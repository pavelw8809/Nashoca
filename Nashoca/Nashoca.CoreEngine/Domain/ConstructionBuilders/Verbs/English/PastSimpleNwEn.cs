...
{
    public class PastSimpleNwEn : VerbConstructionEnBase
    {
        public override string ConstructionNameEn => "Past Simple - Not Witnessed";
        public override string ConstructionDescEn => "Telling about actions in the past I've heard about";
        public PastSimpleNwEn(VerbInputObjTrEn input) : base(input) {
            Input = input;
        }
